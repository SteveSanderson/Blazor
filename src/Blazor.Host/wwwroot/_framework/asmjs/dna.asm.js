...
function _Thread_Execute() {
 ...
 if ((i15 | 0) == 10) _log_f(1, 18956, i13); else if ((i15 | 0) == 22) {
...
function _System_Diagnostics_Debugger_Internal_Break_Point(i1, i3, i2) {
 ...
 if ((HEAP8[i2 >> 0] | 0) == 95) {
  ...
  HEAP32[i6 >> 2] = i4;
  HEAP32[i6 + 4 >> 2] = i1;
  _sprintf(i5, 18575, i6) | 0;
  _invokeJsFunc(18627, 18638, i5 | 0) | 0;
  i1 = _malloc(24) | 0;
  HEAP32[i1 >> 2] = -1;
  HEAP32[i1 + 4 >> 2] = 43;
  HEAP32[i1 + 8 >> 2] = 0;
