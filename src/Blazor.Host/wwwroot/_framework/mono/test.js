...
var assemblies = [ "mscorlib.dll", "System.dll", "System.Core.dll",
 	"dotnetapp.exe"];
...
var main_module = assembly_load ("dotnetapp")
if (!main_module)
	throw 1;

var driver_class = find_class (main_module, "dotnetapp", "Program")
if (!driver_class)
	throw 2;

var send_message = find_method (driver_class, "Main", -1)
if (!send_message)
	throw 3;

call_method (send_message, null, [])
